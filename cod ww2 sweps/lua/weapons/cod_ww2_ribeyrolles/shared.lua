...
include("ribey_sounds.lua")
SWEP.PrintName = "Ribey Rolles"
...
SWEP.ViewModel = "models/codww2/weapons/ribeyrolles.mdl"
...
SWEP.IronsightAng = Vector(0.671, 0.191, 0.000)
...
SWEP.Sounds = {
	...
	draw_first = {
		{time = 0, sound = "WW2.DrawSMG", callback = function(self) end},
				{time = 0.35, sound = "Ribey.Draw_First"},
	},
	holster = {
...
reload = {
		...
		{time = 0.3, sound = "Ribey.Magout"},
		{time = 1.1, sound = "Ribey.Magin"},
		{time = 1.25, sound = "WW2.Movement2"},
	},
	reload_empty = {
		{time = 0, sound = "WW2.Movement1"},
		{time = 0.3, sound = "Ribey.Magout"},
		{time = 1.2, sound = "Ribey.Magin"},
		{time = 3, sound = "Ribey.Bolt"},
...
SWEP.LuaVMRecoilAxisMod = {vert = 0, hor = 0.15, roll = 0.5, forward = 0.6, pitch = 0} -- modifier for intensity of the recoil on varying axes
