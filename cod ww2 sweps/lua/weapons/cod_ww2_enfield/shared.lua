...
SWEP.MuzzleEffect = { "PistolGlow", "btb_vm_large", "muzzle_fire_rifle", "muzzle_sparks_rifle", "muzzle_sparks_rifle","muzzle_sparks_rifle", "muzzle_sparks_rifle", "shotgun_muzzlelong"}
