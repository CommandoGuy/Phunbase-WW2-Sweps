...
SWEP.FireSound = "Sterling.Fire"

SWEP.Sounds = {
	draw_first = {
		{time = 0.15, sound = "Sterling.Draw", callback = function(self) end}
	},
    draw = {
...
reload = {
		...
		{time = 0.4, sound = "Sterling.Magout", callback = function(self) end},
		{time = 1.2, sound = "Sterling.Magin", callback = function(self) end},
	...
	reload_empty = {
		...
		{time = 0.4, sound = "Sterling.Magout", callback = function(self) end},
		{time = 1.2, sound = "Sterling.Magin", callback = function(self) end},
		{time = 2, sound = "Sterling.Bolt", callback = function(self) end},
