...
SWEP.ViewModel = "models/weapons/m1911.mdl"
...
SWEP.IronsightPos = Vector(-4.047, -5.069, 0.726)
SWEP.IronsightAng = Vector(1.166, 0.090, 0.000)
...
SWEP.LuaVMRecoilAxisMod = {vert = 0, hor = 0, roll = 0, forward = 0.2, pitch = 0.1} -- modifier for intensity of the recoil on varying axes