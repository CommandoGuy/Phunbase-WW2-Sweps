...
SWEP.IronsightPos = Vector(-4.053, 0.000, 0.633)
SWEP.IronsightAng = Vector(1.309, 0.000, 0.000)
...
SWEP.Sounds = {
	...
	reload = {
		...
		{time = 1.5, sound = "Thompson_EndReload"}
	},
		reload_empty = {
		{time = 0, sound = "Thompson_StartReload"},
		{time = 1.5, sound = "Thompson_MagTransition"},
		{time = 1.7, sound = "Thompson_EndReload"}
	},
	sprint_in = {
		{time = 0, sound = "Thompson_StartReload"},
	},
	sprint_out = {
		{time = 0, sound = "Thompson_EndReload"},
	},
