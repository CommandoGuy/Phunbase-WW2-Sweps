...
SWEP.ViewModel = "models/codww2/weapons/m2carbine.mdl"
...
SWEP.IronsightPos = Vector(-3.901, -2.290, 0.894)
...
SWEP.Sounds = {
	...
	reload = {
		...
		{time = 0.5, sound = "M1C_Magout"},
		{time = 1.35, sound = "M1C_Magin"},
