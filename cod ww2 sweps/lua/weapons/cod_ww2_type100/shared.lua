...
SWEP.ViewModel = "models/codww2/weapons/type100.mdl"
...
SWEP.IronsightPos = Vector(-3.490, -2.986, 1.624)
SWEP.IronsightAng = Vector(0.276, 0.060, 0.000)
...
SWEP.Sequences = {
	...
	ext_fire = "fire",
	ext_fire_last = "fire_ads",
	ext_fire_last_iron = "fire_ads_last",
...
SWEP.Sounds = {
	...
	draw_first = {
		{time = 0, sound = "WW2.DrawSMG", callback = function(self) end},
		{time = 0.5, sound = "Type100.First_Draw"}
	},
	holster = {
...
reload = {
		...
		{time = 0.25, sound = "Type100.Magout"},
		{time = 1, sound = "Type100.Magin"},
...
// shell-related stuff
SWEP.ShellVelocity = {X = 300, Y = 90, Z = 90}
