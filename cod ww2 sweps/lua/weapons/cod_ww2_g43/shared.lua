...
SWEP.IronsightPos = Vector(-3.928, -5, 1.063)
...
SWEP.MuzzleEffect = { "PistolGlow", "btb_vm_small", "muzzle_fire_pistol", "muzzle_sparks_rifle", "muzzle_sparks_rifle","muzzle_sparks_rifle", "muzzle_sparks_rifle", "pistol_muzzlelong_thin"}
