...
include("type2_sounds.lua")
SWEP.PrintName = "Nambu Type 2"
...
SWEP.ViewModel = "models/codww2/weapons/type2.mdl"
...
SWEP.IronsightPos = Vector(-2.784, 0.000, 0.918)
SWEP.IronsightAng = Vector(0.314, 0.006, -0.354)
...
SWEP.Sounds = {
	...
	draw_first = {
	 {time = 0.15, sound = "WW2.DrawSMG", callback = function(self) end},
	 {time = 0.3, sound = "Type2.Draw_First", callback = function(self) end},
 },
	holster = {
	...
	reload = {
		...
		{time = 0.3, sound = "Type2.Magout", callback = function(self) end},
		{time = 1.35, sound = "Type2.Magin", callback = function(self) end},
	...
	reload_empty = {
		...
		{time = 0.3, sound = "Type2.Magout", callback = function(self) end},
		{time = 1.35, sound = "Type2.Magin", callback = function(self) end},
		{time = 2.35, sound = "Type2.Bolt", callback = function(self) end},
...
SWEP.LuaVMRecoilAxisMod = {vert = 0, hor = 0, roll = 0.5, forward = 0.4, pitch = 0} -- modifier for intensity of the recoil on varying axes
