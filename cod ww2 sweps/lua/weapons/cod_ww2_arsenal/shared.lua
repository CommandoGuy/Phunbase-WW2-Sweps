...
include("arsenal_sounds.lua")
SWEP.PrintName = "Arsenal 1927"
...
SWEP.ViewModel = "models/codww2/weapons/arsenal.mdl"
...
SWEP.IronsightPos = Vector(-3.573, 0.000, 1.100)
SWEP.IronsightAng = Vector(0.400, 0.000, 0.000)
...
// shell-related stuff
SWEP.ShellVelocity = {X = 90, Y = 0, Z = 50}
SWEP.ShellAngularVelocity = {Pitch_Min = -1000, Pitch_Max = 1000, Yaw_Min = -1000, Yaw_Max = 1000, Roll_Min = -500, Roll_Max = 500}
SWEP.ShellViewAngleAlign = {Forward = 0, Right = 0, Up = 175}
...
SWEP.FireSound = "Arsenal.Fire"

SWEP.Sounds = {
	draw_first = {
		{time = 0.15, sound = "Arsenal.Draw", callback = function(self) end}
	},
    draw = {
...
reload = {
		...
		{time = 0.4, sound = "Arsenal.Magout", callback = function(self) end},
		{time = 1.4, sound = "Arsenal.Magin", callback = function(self) end},
		{time = 1.8, sound = "WW2.Movement2", callback = function(self) end}
	},
	reload_empty = {
		{time = 0, sound = "WW2.Movement1", callback = function(self) end},
		{time = 0.4, sound = "Arsenal.Magout", callback = function(self) end},
		{time = 1.4, sound = "Arsenal.Magin", callback = function(self) end},
		{time = 2.3, sound = "Arsenal.Bolt", callback = function(self) end},
...
SWEP.LuaVMRecoilAxisMod = {vert = 0, hor = 0.1, roll = 0.25, forward = 1.25, pitch = 0} -- modifier for intensity of the recoil on varying axes
