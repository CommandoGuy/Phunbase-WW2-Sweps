...
SWEP.MuzzleEffect = {"PistolGlow", "weapon_muzzle_flash_autoshotgun", "muzzle_fire_pistol", "muzzle_sparks_pistol", "muzzle_sparks_pistol", "muzzle_sparks_pistol", "barrel_smoke"}
