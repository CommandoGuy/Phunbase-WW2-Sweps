...
SWEP.ShellViewAngleAlign = {Forward = 0, Right = 0, Up = -150}
...
SWEP.MuzzleEffect = {"PistolGlow", "weapon_muzzle_flash_assaultrifle", "muzzle_fire_pistol", "muzzle_sparks_pistol", "barrel_smoke"}
