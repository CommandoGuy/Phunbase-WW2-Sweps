...
SWEP.IronsightPos = Vector(-3.459, -1.093, 0.347)
SWEP.IronsightAng = Vector(0.091, 0.008, 0.000)
...
SWEP.VElements = {
	["cod_ww2_reflexsight"] = { model = "models/codww2/weapons/fg42.mdl", bonemerge = true, stencilDebug = false, bodygroups = {[1] = 1, [2] = 1}, stencilmaterials = {6}},
}
...
SWEP.LuaVMRecoilAxisMod = {vert = 0.01, hor = 0.15, roll = 0.15, forward = 0.15, pitch = 0} -- modifier for intensity of the recoil on varying axes
